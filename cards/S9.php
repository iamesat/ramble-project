  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/south/S9.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	
	
              <blockquote>
              <center><h2>Reserva Faunistics Peninsula Valdes</h2></center>
              </blockquote>

              <a href="south/e9a.php" class="btn btn--full yea2"><b>Add to photobook</b></a>
