...
$addMoments = $db->prepare("SELECT id, userID, n11 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n11 = :n11 WHERE userID = $id");


  $editAccount->bindValue(':n11',$addOne);
  $editAccount->execute();
