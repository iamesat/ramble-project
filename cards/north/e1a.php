...
$addMoments = $db->prepare("SELECT id, userID, n1 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n1 = :n1 WHERE userID = $id");


  $editAccount->bindValue(':n1',$addOne);
  $editAccount->execute();
