...
$addMoments = $db->prepare("SELECT id, userID, n4 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n4 = :n4 WHERE userID = $id");


  $editAccount->bindValue(':n4',$addOne);
  $editAccount->execute();
