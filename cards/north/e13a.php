...
$addMoments = $db->prepare("SELECT id, userID, n13 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n13 = :n13 WHERE userID = $id");


  $editAccount->bindValue(':n13',$addOne);
  $editAccount->execute();
