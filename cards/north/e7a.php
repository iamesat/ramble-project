...
$addMoments = $db->prepare("SELECT id, userID, n7 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n7 = :n7 WHERE userID = $id");


  $editAccount->bindValue(':n7',$addOne);
  $editAccount->execute();
