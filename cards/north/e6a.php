...
$addMoments = $db->prepare("SELECT id, userID, n6 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n6 = :n6 WHERE userID = $id");


  $editAccount->bindValue(':n6',$addOne);
  $editAccount->execute();
