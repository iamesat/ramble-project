...
$addMoments = $db->prepare("SELECT id, userID, n5 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n5 = :n5 WHERE userID = $id");


  $editAccount->bindValue(':n5',$addOne);
  $editAccount->execute();
