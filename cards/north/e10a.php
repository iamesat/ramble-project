...
$addMoments = $db->prepare("SELECT id, userID, n10 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n10 = :n10 WHERE userID = $id");


  $editAccount->bindValue(':n10',$addOne);
  $editAccount->execute();
