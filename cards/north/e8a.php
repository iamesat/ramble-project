...
$addMoments = $db->prepare("SELECT id, userID, n8 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n8 = :n8 WHERE userID = $id");


  $editAccount->bindValue(':n8',$addOne);
  $editAccount->execute();
