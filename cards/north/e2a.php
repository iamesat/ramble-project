...
$addMoments = $db->prepare("SELECT id, userID, n2 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n2 = :n2 WHERE userID = $id");


  $editAccount->bindValue(':n2',$addOne);
  $editAccount->execute();
