...
$addMoments = $db->prepare("SELECT id, userID, n9 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n9 = :n9 WHERE userID = $id");


  $editAccount->bindValue(':n9',$addOne);
  $editAccount->execute();
