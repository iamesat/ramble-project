...
$addMoments = $db->prepare("SELECT id, userID, n3 FROM noordamerika WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE noordamerika SET n3 = :n3 WHERE userID = $id");


  $editAccount->bindValue(':n3',$addOne);
  $editAccount->execute();
