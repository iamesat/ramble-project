  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/namerica/N6.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	
	
              <blockquote>
              <center><h2>Riding Mountain National Park<h2></center>
              </blockquote>

              <a href="north/e6a.php" class="btn btn--full yea2" disabled><b>Add to photobook</b></a>
