  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/europe/praag.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	
	  
              <blockquote>
              <center><h2>Prague, Czech Republic</h2></center>
              </blockquote>
              ...
              <a href="europe/e8a.php" class="btn btn--full yea2"><b>Add to photobook</b></a>
