  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/africa/our-lady.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	

              <blockquote>
              <center><h2>Basilica of our Lady of peace, Ivoery Coast</h2></center>
              </blockquote>
              
              <blockquote>
              <center><h6>Extra info</h6></center>
              </blockquote>

              <a href="africa/e2a.php" class="btn btn--full yea2"><b>Add to photobook</b></a>
