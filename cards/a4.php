  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/africa/antanarivo.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	
	  
              <blockquote>
              <center><h2>Anatavi, Madagascar</h2></center>
              </blockquote>
              ...
              <a href="africa/e4a.php" class="btn btn--full yea2"><b>Add to photobook</b></a>
