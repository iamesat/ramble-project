  ...
  <div data-page="about" class="page">
    <div class="page-content">
     ...
     <div id="pages_maincontent">
			<img src="../images/europe/barcelona.jpg" alt="" title="" />
              
        <div class="page_single layout_fullwidth_padding">	
              <blockquote>
              <center><h2>Sagrada Familia, Barcelona</h2></center>
              </blockquote>
              ...
              <a href="europe/e1a.php" class="btn btn--full yea2"><b>Add to photobook</b></a>
