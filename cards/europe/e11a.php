...
$addMoments = $db->prepare("SELECT id, userID, e11 FROM europe WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE europe SET e11 = :e11 WHERE userID = $id");


  $editAccount->bindValue(':e11',$addOne);
  $editAccount->execute();
