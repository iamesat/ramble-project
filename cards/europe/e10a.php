...
$addMoments = $db->prepare("SELECT id, userID, e10 FROM europe WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE europe SET e10 = :e10 WHERE userID = $id");


  $editAccount->bindValue(':e10',$addOne);
  $editAccount->execute();
