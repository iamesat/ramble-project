...
$addMoments = $db->prepare("SELECT id, userID, a10 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a10 = :a10 WHERE userID = $id");


  $editAccount->bindValue(':a10',$addOne);
  $editAccount->execute();
