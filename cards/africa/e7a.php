...
$addMoments = $db->prepare("SELECT id, userID, a7 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a7 = :a7 WHERE userID = $id");


  $editAccount->bindValue(':a7',$addOne);
  $editAccount->execute();
