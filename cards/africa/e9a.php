...
$addMoments = $db->prepare("SELECT id, userID, a9 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a9 = :a9 WHERE userID = $id");


  $editAccount->bindValue(':a9',$addOne);
  $editAccount->execute();
