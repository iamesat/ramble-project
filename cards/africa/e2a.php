...
$addMoments = $db->prepare("SELECT id, userID, a2 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a2 = :a2 WHERE userID = $id");


  $editAccount->bindValue(':a2',$addOne);
  $editAccount->execute();
