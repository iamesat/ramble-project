...
$addMoments = $db->prepare("SELECT id, userID, a11 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a11 = :a11 WHERE userID = $id");


  $editAccount->bindValue(':a11',$addOne);
  $editAccount->execute();
