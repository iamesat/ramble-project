...
$addMoments = $db->prepare("SELECT id, userID, a6 FROM afrika WHERE userID=$id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE afrika SET a6 = :a6 WHERE userID = $id");


  $editAccount->bindValue(':a6',$addOne);
  $editAccount->execute();
