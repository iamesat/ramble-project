  ...
  <!-- https://nl.freepik.com/vrije-vector/man-met-paspoort-op-de-luchthaven_1086751.htm'>Designed by Photoroyalty -->
	  ...
	  <br>
              ...
              if ($user[7] < 225){
                ...
                echo "<a href='../functions/airports/f_aus.php' class='btn btn--full yea2' style='background-color:#66b32e; font-size:20px;'><b>Ticket to Europe</b></a>";
              ...
              if ($user[7] < 225){
                ...
                echo "<a href='../functions/airports/f_aus.php' class='btn btn--full yea2' style='background-color:#feeb15;font-size:20px;'><b>Ticket to Africa</b></a>";
              ...
              if ($user[7] < 225){
                ...
                echo "<a href='../functions/airports/f_aus.php' class='btn btn--full yea2' style='background-color:#eb8a00;font-size:20px;'><b>Ticket to North-America</b></a>";
              ...
              if ($user[7] < 225){
                ...
                echo "<a href='../functions/airports/f_aus.php' class='btn btn--full yea2' style='background-color:#00b6e3;font-size:20px;'><b>Ticket to Asia</b></a>";
              ...
              if ($user[7] < 225){
                ...
                echo "<a href='../functions/airports/f_aus.php' class='btn btn--full yea2' style='background-color:#00b6e3;font-size:20px;'><b>Ticket to South-America</b></a>";
