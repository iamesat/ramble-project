...
$addMoments = $db->prepare("SELECT id, userID, c11 FROM australie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE australie SET c11 = :c11 WHERE userID = $id");


  $editAccount->bindValue(':c11',$addOne);
  $editAccount->execute();
