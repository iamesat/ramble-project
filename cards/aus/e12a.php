...
$addMoments = $db->prepare("SELECT id, userID, c12 FROM australie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE australie SET c12 = :c12 WHERE userID = $id");


  $editAccount->bindValue(':c12',$addOne);
  $editAccount->execute();
