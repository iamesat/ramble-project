...
$addMoments = $db->prepare("SELECT id, userID, c13 FROM australie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE australie SET c13 = :c13 WHERE userID = $id");


  $editAccount->bindValue(':c13',$addOne);
  $editAccount->execute();
