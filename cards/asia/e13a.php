...
$addMoments = $db->prepare("SELECT id, userID, z13 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z13 = :z13 WHERE userID = $id");


  $editAccount->bindValue(':z13',$addOne);
  $editAccount->execute();
