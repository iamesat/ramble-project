...
$addMoments = $db->prepare("SELECT id, userID, z3 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z3 = :z3 WHERE userID = $id");


  $editAccount->bindValue(':z3',$addOne);
  $editAccount->execute();
