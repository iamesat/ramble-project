...
$addMoments = $db->prepare("SELECT id, userID, z9 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z9 = :z9 WHERE userID = $id");


  $editAccount->bindValue(':z9',$addOne);
  $editAccount->execute();
