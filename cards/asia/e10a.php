...
$addMoments = $db->prepare("SELECT id, userID, z10 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z10 = :z10 WHERE userID = $id");


  $editAccount->bindValue(':z10',$addOne);
  $editAccount->execute();
