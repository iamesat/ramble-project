...
$addMoments = $db->prepare("SELECT id, userID, z1 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z1 = :z1 WHERE userID = $id");


  $editAccount->bindValue(':z1',$addOne);
  $editAccount->execute();
