...
$addMoments = $db->prepare("SELECT id, userID, z7 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z7 = :z7 WHERE userID = $id");


  $editAccount->bindValue(':z7',$addOne);
  $editAccount->execute();
