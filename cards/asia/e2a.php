...
$addMoments = $db->prepare("SELECT id, userID, z2 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z2 = :z2 WHERE userID = $id");


  $editAccount->bindValue(':z2',$addOne);
  $editAccount->execute();
