...
$addMoments = $db->prepare("SELECT id, userID, z18 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z18 = :z18 WHERE userID = $id");


  $editAccount->bindValue(':z18',$addOne);
  $editAccount->execute();
