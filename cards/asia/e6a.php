...
$addMoments = $db->prepare("SELECT id, userID, z6 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z6 = :z6 WHERE userID = $id");


  $editAccount->bindValue(':z6',$addOne);
  $editAccount->execute();
