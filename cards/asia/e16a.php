...
$addMoments = $db->prepare("SELECT id, userID, z16 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z16 = :z16 WHERE userID = $id");


  $editAccount->bindValue(':z16',$addOne);
  $editAccount->execute();
