...
$addMoments = $db->prepare("SELECT id, userID, z8 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z8 = :z8 WHERE userID = $id");


  $editAccount->bindValue(':z8',$addOne);
  $editAccount->execute();
