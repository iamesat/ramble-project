...
$addMoments = $db->prepare("SELECT id, userID, z17 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z17 = :z17 WHERE userID = $id");


  $editAccount->bindValue(':z17',$addOne);
  $editAccount->execute();
