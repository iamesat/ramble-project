...
$addMoments = $db->prepare("SELECT id, userID, z11 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z11 = :z11 WHERE userID = $id");


  $editAccount->bindValue(':z',$addOne);
  $editAccount->execute();
