...
$addMoments = $db->prepare("SELECT id, userID, z5 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z5 = :z5 WHERE userID = $id");


  $editAccount->bindValue(':z5',$addOne);
  $editAccount->execute();
