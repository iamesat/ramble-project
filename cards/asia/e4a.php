...
$addMoments = $db->prepare("SELECT id, userID, z4 FROM azie WHERE userID = $id");
$addMoments->execute();
...
if (isset($_POST)) {
  ...
  $editAccount = $db->prepare("UPDATE azie SET z4 = :z4 WHERE userID = $id");


  $editAccount->bindValue(':z4',$addOne);
  $editAccount->execute();
